...
ITEM_COSTS = {
    101: Item("Chocolate Almonds", 10, 0.4),
    102: Item("Butter Toffee Peanuts", 10, 0.4),
    103: Item("Cranberry Fitness Mix", 10, 0.4),
    104: Item("Mixed Nuts", 10, 0.4),
    105: Item("Hot & Spicy Nuts", 10, 0.4),
    106: Item("Sweet N Crunchy Trail Mix", 10, 0.4),
    107: Item("Gummi Bears", 10, 0.4),
    108: Item("Neon Sour Gummi Worms", 10, 0.4),
    109: Item("Fruit Slices", 10, 0.4),
    110: Item("Peanut Butter Bears", 14, 0.4),
    111: Item("English Butter Toffee", 14, 0.4),
    112: Item("Pecan Buds", 14, 0.4),
    113: Item("Chocolate Covered Pretzels", 10, 0.4),
    114: Item("Chocolate Covered Raisins", 10, 0.4),
    115: Item("Cracked Pepper & Sea Salt Cashews", 10, 0.4),
    116: Item("Honey Roasted Peanuts", 10, 0.4),
    201: Item("Kettle Popcorn", 20, 0.4),
    202: Item("Buttery Caramel", 20, 0.4),
    203: Item("Cheesy Cheddar", 20, 0.4),
    204: Item("Chicago", 20, 0.4),
    205: Item("Fruity", 20, 0.4),
    206: Item("Jalapeno Cheddar", 20, 0.4),
    207: Item("Chocolate Delight", 20, 0.4),
    208: Item("Movie Theater Popcorn", 20, 0.4),
    209: Item("Cookies & Cream", 20, 0.4),
    210: Item("Texas Cheddar Habanero", 20, 0.4),
    301: Item("Chocolate Chip Cookies", 25, 0.4),
    302: Item("Peanut Butter Cookies", 25, 0.4),
    303: Item("Cinnabon Cookies", 25, 0.4),
